...
public class Locations {
    ...
    public static final Location.Location Lumbridge = new Location.Location("Lumbridge", new Area(0, new Tile(3211,3215,0), new Tile(3211,3216,0)), RSBank.LUMBRIDGE_TOP, new HashMap<String, Integer>());
