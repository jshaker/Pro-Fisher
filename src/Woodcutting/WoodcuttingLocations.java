...
public class WoodcuttingLocations {
    ...
    public static final WoodcuttingLocation draynor_willows = new WoodcuttingLocation("Draynor", new Area(new Tile(3087, 3233), 5), null, Trees.willow_tree, RSBank.DRAYNOR);
