...
public class WoodcuttingLocations {
    ...
    public static final WoodcuttingLocation remmington_willows = new WoodcuttingLocation("Remmington", new Area(new Tile(2967, 3195), 5), null, Trees.willow_tree, RSBank.FALADOR_EAST);
